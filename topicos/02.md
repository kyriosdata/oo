### Tópico T02 (data limite: **23/06/2023 23h59min59s**)
...
1. Se posso converter algo dito OO para algo que não é OO e ainda obter os mesmos resultados, e tal conversão existe para
   qualquer código em C++, que pode ser convertido para C, então o que supostamente se ganha com código em C++ em relação ao código em C correspondente? Desenvolva a sua resposta (o trecho abaixo pode ser útil).
...
1. Reflexão e discussão com os estudantes.
